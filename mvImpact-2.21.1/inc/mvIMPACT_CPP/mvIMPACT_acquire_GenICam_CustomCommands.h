...
//-----------------------------------------------------------------------------
{
    ...
    void prepareCommandProtocolHeader( char* pBuf, const uint16_type commandSize )
    {
        ...
        pHeader->interpreterVersionMajor = hostToNet16( uint16_type( 1 ) );
        pHeader->interpreterVersionMinor = hostToNet16( uint16_type( 0 ) );
...
public:
    ...
    {
        queueSequencerSetValueModification( sequencerSet, parameter, value );
        return sendCommandBuffer();
    }
    /// \brief Modifies a value of a certain sequencer set at runtime.
    /**
